...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lineEdit_CrawlingCookie.setGeometry(QtCore.QRect(40, 110, 311, 111))
        ...
        self.pushButton_SQLInject.setGeometry(QtCore.QRect(360, 50, 91, 31))
        ...
        self.lineEdit_target.setGeometry(QtCore.QRect(30, 50, 201, 31))
        self.lineEdit_target.setObjectName("lineEdit_target")
        self.lab_target = QtWidgets.QLabel(self.tab_3)
        self.lab_target.setGeometry(QtCore.QRect(0, 50, 31, 21))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_pull.setText(_translate("MainWindow", "拉取结果"))
